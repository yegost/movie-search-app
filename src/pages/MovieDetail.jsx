...
function MovieDetail() {
    ...
    const watchGB = movie["watch/providers"]?.results?.GB
    const flatrate = watchGB?.flatrate
    ...
    return(
        <div className="min-h-screen bg-zinc-950 text-white">
            <NavBar />
            <section className="relative overflow-hidden min-h-100 bg-gray-900 flex items-end">
                <img src={`https://image.tmdb.org/t/p/original${movie.backdrop_path}`}
                    className="absolute right-0 top-0 h-full w-5/6 object-cover object-top-left"
                />
                <div className="absolute inset-0 bg-linear-to-r from-black via-gray-900/30 bg-black/80" />
                ...
                <section className="max-w-5xl mx-auto w-full px-6 md:px-16">
                    <div className="flex flex-col md:flex-row justify-between gap-10 pb-10">
                        ...
                        <div className="flex flex-col gap-5 w-full md:w-55">
                            ...
                            <div className="bg-zinc-900 rounded-lg p-5 border-l-2 border-r-2 border-red-500 md:w-55">
